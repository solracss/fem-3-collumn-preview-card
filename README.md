# Frontend Mentor - [3-column preview card](https://www.frontendmentor.io/challenges/3column-preview-card-component-pH92eAR2-)
...
1. Using `mix-blend-mode: screen;` for button to have transparent text color.
